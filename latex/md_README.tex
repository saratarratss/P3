...
Recuerde realizar el {\itshape pull request} al repositorio original una vez completada la práctica.\hypertarget{md_README_autotoc_md0}{}\doxysection{Ejercicios básicos}\label{md_README_autotoc_md0}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_README_autotoc_md1}{}\doxysection{Ejercicios de ampliación}\label{md_README_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{md_README_autotoc_md2}{}\doxysection{Evaluación $<$em$>$ciega$<$/em$>$ del estimador}\label{md_README_autotoc_md2}
